...
<section class="section single-news white">
    <div class="content">
        <!-- <a href="<?php echo get_home_url(); ?>/cases"></a> -->
        <a href="javascript:history.go(-1)">
            <h6 class="cta-goback"><?php pll_e('Terug naar nieuwsoverzicht'); ?></h6>
        </a>
        ...
        <div class="single-content-wrapper">
            ...
            <div class="single-info white">
                ...
                <div class="features">
                    <div class="content post-date-desktop">
                        <h5>
                            <?php echo get_the_date(); ?>
                        </h5>
                    </div>
                    <div class="content <?php if (!in_category('Uncategorized')) {
                                            echo "no-cat";
                                        } ?>">
